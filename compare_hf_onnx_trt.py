...
print("processor loaded, used ", time.time() - start, " seconds")
...
print("model loaded, used ", time.time() - start, " seconds")
...
print("pipeline loaded, used ", time.time() - start, " seconds")


start = time.time()
image=Image.open("examples/pokemon.jpeg")
...
print("getImageEmbedding used ", time.time() - start, " seconds")
...
print("get Image Embedding onnx used ", time.time() - start, " seconds")
...
print("getImageEmbedding trt used ", time.time() - start, " seconds")
